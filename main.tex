...
\email{20210240043@fudan.edu.cn}
\affiliation{
  \institution{Fudan University}
  \city{Shanghai 200433}
  \country{China}
...
% \email{{hsxia18,20210240043,zhangzz}@fudan.edu.cn}
% \affiliation{
...
% \email{zqsong19@fudan.edu.cn}
% \affiliation{
%   \institution{Shanghai Center for Mathematical Sciences, Fudan University, Shanghai 200433, China}
%   \city{}\country{}
% }
\begin{abstract}
...
\begin{lemma}[SDD Solver~\cite{CoKyMiPaJaPeRaXu14,SpTe14,GaKySp23}]\label{lem:solver}
...
Combining \algoref{algo:approxh} and \algoref{algo:approxdelta}, we can give the faster greedy algorithm \textsc{Approx} with a \(1-\frac{k}{k-1}\cdot\frac{1}{e}-\epsilon\) approximate factor.
...
\begin{figure}
  ...
  \begin{tikzpicture}[scale=\scaleoptimum,baseline]
    \begin{axis}[
        ...
        legend entries={Approx,Exact,Optimum},
      ]
      \addplot+[
        mark=pentagon*,
        mark size = 3pt
  ...
  \begin{tikzpicture}[scale=\scaleoptimum,baseline]
    \begin{axis}[
      ...
      \node [font=\huge] at (3.5,7) {Zachary karate club};
    \end{axis}
  \end{tikzpicture}
  ...
  \begin{tikzpicture}[scale=\scaleoptimum,baseline]
    \begin{axis}[
      ...
      \node [font=\huge] at (3.5,25) {Contiguous USA};
    \end{axis}
  \end{tikzpicture}
  \begin{tikzpicture}[scale=\scaleoptimum,baseline]
    \begin{axis}[
      ...
      \addplot+[
        mark=pentagon*,
        mark size = 3pt
      ] table {compare_effects/optimum/Les Misérables/Approx.dat};
      \addplot table {compare_effects/optimum/Les Misérables/Exact.dat};
      \addplot table {compare_effects/optimum/Les Misérables/Optimum.dat};
      \node [font=\huge] at (3.5,9) {Les Misérables};
    \end{axis}
  \end{tikzpicture}
  \caption{MANC \(\manc{S}\) of node set \(S\) computed by three different algorithms(\textsc{Exact},\textsc{Approx} and \textsc{Optimum}).\label{pic:compare-effect-optimum}}
\end{figure}
...
We run these four algorithms on four medium-sized networks, the results is shown in \figref{pic:compare-effect}.
...
\begin{figure}
  ...
  \begin{tikzpicture}[scale=\scaleexact,baseline]
    \begin{semilogyaxis}[
        ...
        legend entries={Approx,Exact,Top-Absorb,Top-Degree,Top-PageRank},
        ymax=800,
      ]
      \addplot+[
        mark=pentagon*,
      ...
      \node [font=\large] at (15,30) {CA-GrQc};
    \end{semilogyaxis}
  \end{tikzpicture}
  \begin{tikzpicture}[scale=\scaleexact,baseline]
    \begin{semilogyaxis}[
      ...
      \node [font=\large] at (20,200) {ego-Facebook};
    \end{semilogyaxis}
  \end{tikzpicture}
  ...
  \begin{tikzpicture}[scale=\scaleexact,baseline]
    \begin{semilogyaxis}[
      ...
      \node [font=\Large] at (15,25) {Euroroads};
    \end{semilogyaxis}
  \end{tikzpicture}
  \begin{tikzpicture}[scale=\scaleexact,baseline]
    \begin{semilogyaxis}[
      ...
      \node [font=\Large] at (15,90) {US power grid};
    \end{semilogyaxis}
  \end{tikzpicture}
  \caption{MANC \(\manc{S}\) of node set \(S\) computed by four different algorithms(\textsc{Exact},\textsc{Approx},\textsc{Top-Absorb} and \textsc{Top-Degree}).\label{pic:compare-effect}}
\end{figure}

% \captionof{figure}{MANC \(\manc{S}\) of node set \(S\) computed by four different algorithms(\textsc{Exact},\textsc{Approx},\textsc{Top-Absorb} and \textsc{Top-Degree}).\label{pic:compare-effect}}
