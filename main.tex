...
According to \eqref{eq:AGC} and \lemref{lemma:ST}, we can easily compute AGC of any given vertex group \(S\) by calling \(\mathtt{Solve}\mypar{\lap_{-S},\vecs_{-S},\delta}\).
