...
We execute these four algorithms on four medium-sized networks, and the results are shown in \figref{pic:compare-effect}.
As displayed in \figref{pic:compare-effect}, both of our algorithms produce similar approximate solutions in larger networks, which outperform the solutions of other algorithms.
...
\begin{figure}
    ...
    \begin{tikzpicture}[scale=\scaleexact,baseline]
        ...
        \end{semilogyaxis}
    \end{tikzpicture}
    \caption{AGC \(\manc{S}\) of vertex group \(S\) computed by four different algorithms(\textsc{ExactAGCM},\textsc{ApproxAGCM},\textsc{Top-Absorb} and \textsc{Top-Degree}) on four networks: CA-GrQc (a), ego-Facebook (b), Euroroads (c) and US power grid (d).\label{pic:compare-effect}}
\end{figure}
...
\begin{table}[htbp]
    ...
    \begin{threeparttable}
        ...
        \begin{tabularx}{8.25cm}{c p{1cm} p{0.5cm} p{0.5cm} p{0.5cm}}
            ...
            Jazz musicians                  & --      & --      & --       & --\cr
            Euroroads                       & 0.498   & --      & --       & --\cr
            Hamster friends                 & 1.183   & --      & --       & --\cr
            Hamster full                    & 1.267   & --      & --       & --\cr
            Facebook (NIPS)                 & 10.20   & --      & --       & --\cr
            CA-GrQc                         & 10.74   & --      & --       & --\cr
            US power grid                   & 17.62   & --      & --       & --\cr
            Reactome                        & 30.13   & --      & --       & --\cr
            Route views                     & 37.55   & --      & --       & --\cr
            CA-HepTh                        & 85.83   & --      & --       & --\cr
            Sister cities                   & 143.3   & --      & --       & --\cr
            Pretty Good Privacy             & 157.7   & --      & --       & --\cr
            CA-HepPh                        & 180.8   & --      & --       & --\cr
            Astro-ph                        & 715.8   & --      & --       & --\cr
            CAIDA                           & 2272    & --      & --       & --\cr
            Brightkite*                     & --      & --      & --       & --\cr
