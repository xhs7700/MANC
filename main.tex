...
%     \item Solving the AGC minimization problem with an approximation factor.
% \end{itemize}
...
\begin{table*}[htbp]
    ...
    \begin{threeparttable}
        ...
        \begin{tabular}{ccccccc}
            ...
            \specialrule{0em}{3pt}{3pt}
            \(\mathcal{C}_{3,19}\)          & 1,572,862 & 1,572,861 & 52,953,206  & --            & --             & --\cr
            \specialrule{0em}{3pt}{3pt}
            \(\overline{\mathcal{H}}_{13}\) & 2,125,764 & 3,188,646 & 975,712,653 & --            & --             & --\cr
            \specialrule{0em}{3pt}{3pt}
            \bottomrule
        \end{tabular}
    \end{threeparttable}
