...
\begin{IEEEproof}
    ...
    %The last inequality follows by the fact that  \(\sum_{\edge{a}{b} \in E} w_{ab} R_{ab} = n-1\).
...
In addition to good efficiency, \algoref{algo:exact-gwcm} is very effective since it has a $(1-\frac{k}{k-1}\frac{1}{e})$ approximation factor, as shown in the following theorem.
\begin{theorem}
