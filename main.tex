...
Then, we attempt to reformulate MANC as the quadratic form of either the pseudoinverse of Laplacian matrix or the inverse of a SDDM matrix so that we can approximate it by using SDD solver~\cite{GaKySp23} and Johnson-Lindenstrauss Lemma~\cite{JoLi84}.
...
\begin{lemma}[SDD Solver~\cite{GaKySp23}]\label{lem:solver}
